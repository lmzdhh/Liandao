...
mkdir -p $KUNGFU_JOURNAL_DIR/MD/OCEANEX2
mkdir -p $KUNGFU_JOURNAL_DIR/MD_RAW/OCEANEX2
mkdir -p $KUNGFU_JOURNAL_DIR/TD/OCEANEX2
mkdir -p $KUNGFU_JOURNAL_DIR/TD_SEND/OCEANEX2
mkdir -p $KUNGFU_JOURNAL_DIR/TD_RAW/OCEANEX2
mkdir -p $KUNGFU_JOURNAL_DIR/TD_Q/OCEANEX2
