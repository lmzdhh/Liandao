...
context_usage = \
    [   # utilities
        ...
        ('insert_market_order', lambda strategy: strategy.insert_market_order,
         ...
         ('int', [('int', 'source'), ('str', 'ticker'), ('str', 'exchange_id'), ('int', 'volume'), ('DIRECTION', 'direction'), ('OFFSET', 'offset'), ('str', 'misc_info'),('int','expect_price')])),
        ('insert_limit_order', lambda strategy: strategy.insert_limit_order,
         'insert limit order, return order_id (-1 if failed)',
         ('int', [('int', 'source'), ('str', 'ticker'), ('str', 'exchange_id'), ('int', 'price'), ('int', 'volume'), ('DIRECTION', 'direction'), ('OFFSET', 'offset'), ('str', 'misc_info')])),
...
override_methods = [
    ...
    ('on_price_book', (None, [('context', 'context object', CONTEXT_COMMENT),
