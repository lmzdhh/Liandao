...
public:
    ...
    /** take actions */
    int insert_market_order(short source, string instrument_id, string exchange_id, uint64_t volume, LfDirectionType direction, LfOffsetFlagType offset,string misc_info = "",int64_t expect_price = 0);
    ...
    int withdraw_currency(short source, string currency,int64_t volume,string address,string tag);
    ...
    string gen_md_trigger_tag(long time,short source,bool is_hedge = false,bool is_post_only = false);
    string gen_trade_trigger_tag(long time,short source,bool is_hedge = false,bool is_post_only = false);
    string gen_cancel_trigger_tag(long time,short source,int order_ref,int request_id,bool is_hedge = false,bool is_post_only = false);
    string gen_timeout_trigger_tag(long time,short source,bool is_hedge = false,bool is_post_only = false);
};
