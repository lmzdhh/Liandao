...
public:
    ...
    virtual void on_market_bar_data(const LFBarMarketDataField* data, short source, long rcv_time) = 0;
    virtual void on_price_book_update(const LFPriceBook20Field* data, short source, long rcv_time) = 0;
    virtual void on_funding_update(const LFFundingField* data, short source, long rcv_time) = 0;
    ...
    virtual void on_withdraw(const LFWithdrawField* data, int request_id, short source, long rcv_time) = 0;
