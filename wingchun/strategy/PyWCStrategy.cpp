...
BOOST_PYTHON_MODULE(libwingchunstrategy)
{
    ...
    .def("insert_market_order", &PyWCStrategy::insert_market_order_py, (bp::arg("source"), bp::arg("ticker"), bp::arg("exchange_id"), bp::arg("volume"), bp::arg("direction"), bp::arg("offset"), bp::arg("misc_info")=""))
