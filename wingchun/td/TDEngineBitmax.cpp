...
void TDEngineBitmax::readWhiteLists(AccountUnitCoinmex& unit, const json& j_config)
{
...
bool TDEngineBitmax::hasSymbolInWhiteList(std::vector<SubscribeCoinmexBaseQuote> &sub, std::string symbol)
{
...
//example: btc_usdt
void TDEngineBitmax::split(std::string str, std::string token, SubscribeCoinmexBaseQuote& sub)
{
    if (str.size() > 0) {
...
void TDEngineBitmax::debug_print(std::vector<SubscribeCoinmexBaseQuote> &sub)
{
    int count = sub.size();
...
void TDEngineBitmax::debug_print(std::map<std::string, std::string> &keyIsStrategyCoinpairWhiteList)
{
    std::map<std::string, std::string>::iterator map_itr;
...
std::string TDEngineBitmax::getWhiteListCoinpairFrom(AccountUnitCoinmex& unit, const char_31 strategy_coinpair)
{
